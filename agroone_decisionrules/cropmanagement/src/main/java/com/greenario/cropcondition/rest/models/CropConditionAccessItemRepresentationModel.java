...
/** EntityModel class for {@link CropConditionAccessItem}. */
public class CropConditionAccessItemRepresentationModel
    extends RepresentationModel<CropConditionAccessItemRepresentationModel> {

  /** Unique Id. */
  private String accessItemId;
  /** The cropCondition Id. */
  private String cropConditionId;
  /**
   * The Access Id. This could be either a user Id or a full qualified group Id.
   */
  private String accessId;
  /** The cropCondition key. */
  private String cropConditionKey;
  /** The name. */
  private String accessName;
  /** The permission to read the information about the cropCondition. */
  private boolean permRead;
  /**
   * The permission to access a cropConditionMonitoring from the cropCondition.
   */
  private boolean permReadCropConditionMonitorings;
  /**
   * The permission to view the content (the cropConditionMonitorings) of a
   * cropCondition.
   */
  private boolean permOpen;
  /**
   * The permission to add cropConditionMonitorings to the cropCondition. Required
   * for creation
   * and
   * transferring of cropConditionMonitorings.
   */
  private boolean permAppend;
  /** The permission to edit a cropConditionMonitoring from the cropCondition. */
  private boolean permEditCropConditionMonitorings;
  /**
   * The permission to transfer cropConditionMonitorings (out of the current
   * cropCondition).
   */
  private boolean permTransfer;
  /**
   * The permission to distribute cropConditionMonitorings from the cropCondition.
   */
  ...
  public String getCropConditionKey() {
    return cropConditionKey;
  }

  public void setCropConditionKey(String cropConditionKey) {
  ...
  public boolean isPermReadCropConditionMonitorings() {
    return permReadCropConditionMonitorings;
  }

  public void setPermReadCropConditionMonitorings(boolean permReadCropConditionMonitorings) {
    this.permReadCropConditionMonitorings = permReadCropConditionMonitorings;
  }
  ...
  public boolean isPermEditCropConditionMonitorings() {
    return permEditCropConditionMonitorings;
  }

  public void setPermEditCropConditionMonitorings(boolean permEditCropConditionMonitorings) {
    this.permEditCropConditionMonitorings = permEditCropConditionMonitorings;
  }
